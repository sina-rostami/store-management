...
class Backend:
    ...
    def add_mock_values_to_db(self):
        ...
        self.database_session.add(Product(name='چای', price=1000, category_id=1))
        self.database_session.add(Product(name='نسکافه', price=7000, category_id=1))
        self.database_session.add(Product(name='آبمیوه', price=8000, category_id=1))
        self.database_session.add(Product(name='نان', price=9000, category_id=1))
        self.database_session.add(Product(name='املت', price=2000, category_id=1))
        self.database_session.add(Product(name='سیب', price=3000, category_id=1))
        self.database_session.add(Product(name='گوجه', price=5000, category_id=1))
        self.database_session.add(Product(name='دوغ', price=6000, category_id=1))
        self.database_session.commit()

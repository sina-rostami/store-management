...
class Backend:
    ...
    def add_mock_values_to_db(self):
        ...
        self.database_session.add(Product(name='چای', price=1000, stock_number=5, category_id=1, is_active=True))
        self.database_session.add(Product(name='نسکافه', price=7000, stock_number=2, category_id=1, is_active=True))
        self.database_session.add(Product(name='آبمیوه', price=8000, stock_number=10, category_id=1, is_active=True))
        self.database_session.add(Product(name='نان', price=9000, stock_number=10, category_id=1, is_active=True))
        self.database_session.add(Product(name='املت', price=2000, stock_number=1, category_id=1, is_active=True))
        self.database_session.add(Product(name='سیب', price=3000, stock_number=10, category_id=1, is_active=True))
        self.database_session.add(Product(name='سیگار', price=5000, stock_number=3, category_id=1, is_active=True))
        self.database_session.add(Product(name='گوجه', price=6000, stock_number=2, category_id=1, is_active=True))
        self.database_session.commit()
